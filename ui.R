shinyUI(navbarPage("Text-Mining the US National Security Strategy Reports",
  ...
  tabPanel("Word Counts",
      ...
      mainPanel(
           p("Use the text field to the right to specify a term to plot, and check or uncheck the box to switch
      ...
      sidebarPanel(
           textInput("term", h5("Input a term:"), value = "terror"), 
           checkboxInput("normalize", h5("Normalize?"), value=TRUE)
      ),
  
      plotOutput("lineplot", width = "800px", height = "350px", inline = span())
  ...
  tabPanel("Word Clouds",
      ...
      sidebarPanel(
           selectInput("report", h5("Select a report:"),
  ...
  tabPanel("Associations",
       ...
       sidebarPanel(
            textInput("term2", h5("Input a term:"), value = "genocid")
       ),
